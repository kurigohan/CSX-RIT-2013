 ...
 * DoctorsOffice.java
 *
 *  $Id: DoctorsOffice.java,v 1.6 2013/11/12 03:40:14 andy Exp andy $
 *
 *  Revisions:
...
public class DoctorsOffice {
    ...
    public static void main( String args[] ) throws NoSuchPatientException {
        try {
            ...
            System.out.println( "New patient added" );
            patientId = testOffice.addPatient( "deer", "doe", 22 );
            System.out.println( "Patient ID: " + patientId );
            testOffice.printMedicationDetail( patientId );
           ...
           // System.out.println();
            ...
            // activity 2 test (comparator)
            testOffice.addPatient( "joe" , "smith", 22 );
